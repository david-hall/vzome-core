 ...
 *
 */
public class PhiPlusSqrtFieldApplication extends PentagonFieldApplication<PhiPlusSqrtField>
{
	public PhiPlusSqrtFieldApplication(int radicand)
	{
		super( new PhiPlusSqrtField(radicand) );
...
//	final FieldApplication.SymmetryPerspective dodecagonalPerspective = new FieldApplication.SymmetryPerspective()
//    {

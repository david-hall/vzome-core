...
public class HeptagonalAntiprismSymmetry extends AbstractSymmetry
{
	...
	public HeptagonalAntiprismSymmetry( AlgebraicField field, String frameColor, String defaultStyle, boolean correctedOrbits )
	{
        ...
        skewFactor = Math .sin( (3.0d/7.0d) * Math.PI ); // eventually, the 3 and 7 will be calculated from PolygonField
	...
	protected void createFrameOrbit( String frameColor )
	{
        ...
        AlgebraicNumber s = hf .createAlgebraicNumber( new int[] { 0, 0, 1 } ).reciprocal(); // reciprocal of sigma
